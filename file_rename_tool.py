...
class FileRenameTool:
        ...
        def __init__(self, root):
                ...
                self.root.geometry("1100x900")  # 增加窗口尺寸以适应新布局
        ...
        def create_widgets(self):
                ...
                paned_window.add(result_frame, weight=9)  # 增大预览面板权重
                ...
                paned_window.add(log_frame, weight=1)  # 减小日志面板权重
                log_frame.rowconfigure(0, weight=1)
                log_frame.columnconfigure(0, weight=1)
                self.log_text = scrolledtext.ScrolledText(log_frame, state=tk.DISABLED, wrap=tk.WORD, height=6)
                ...
                def _set_initial_sash():
                        try:
                                ...
                                if height > 0:
                                        paned_window.sashpos(0, int(height * 0.86))  # 约 86% 给预览
                        except Exception:
                                pass
